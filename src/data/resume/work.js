...
const work = [
  {
    ...
    highlights: [
      ...
      'Developed an embeddings-based model for image-based product validation using a triplet network, leveraging EfficientNetB0 for feature extraction, CBAM to enhance relevant features, and triplet loss to differentiate between similar and dissimilar products, effectively identifying misshipments and product damage.',
